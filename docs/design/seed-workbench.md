...
| **W-B5 — Workbench runner** | allow-listed command runner for the workbench | done ([#232](https://github.com/philipdallen/rubato/issues/232)) |
| **W-B6 — Seed corpus tree** | master index shell | done ([#233](https://github.com/philipdallen/rubato/issues/233)) |
| **W-B7 — File explorer** | read-only file explorer + text viewer | done ([#234](https://github.com/philipdallen/rubato/issues/234)) |
| **W-B8 — Terminal mode** | pipeline GUI + embedded prompt/chat | done ([#235](https://github.com/philipdallen/rubato/issues/235)) |
| **W-B9 — Lineage probe** ([#253](https://github.com/philipdallen/rubato/issues/253)) | "Lineage check" probe row + per-revision integrity signal (verified/broken/missing) in iteration history (proposal: [lineage chain](proposal-lineage-chain.md) §2.5) | S3.8a ([#251](https://github.com/philipdallen/rubato/issues/251)) |
