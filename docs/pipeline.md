...
| T6 — Committed-mockup guard | load + render the committed `*.mockup.json` artifacts so format drift fails loudly | filed [#275](https://github.com/allenpd728/muse/issues/275) |
