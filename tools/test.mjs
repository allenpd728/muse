...
// Cross-reference lint lives in tools/refs.mjs (pure ESM, browser-safe — the
// explorer bundles it). Re-exported here so existing imports of
// tools/test.mjs keep working.
export { danglingRefs, baseRef } from "./refs.mjs";
